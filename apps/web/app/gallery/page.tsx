...
export const metadata: Metadata = {
  title: "Beacon Gallery — top-scored Claude Code skills",
  description:
    "A leaderboard of publicly graded Claude Code skills, ranked by Beacon's evidence-cited quality score.",
  ...
  return (
    <main className="wrap">
      ...
      <section className="head">
        <h1>Gallery</h1>
        <p>Publicly graded Claude Code skills, ranked by Beacon&apos;s evidence-cited quality score.</p>
